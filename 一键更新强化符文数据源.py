...
def getData(url: str):
    ...
    # 构建符合我们格式的数据
    for tag in items:
        if items[tag].get('type') != '0':
            temp.append(items[tag].get('name'))
    return temp
...
if __name__ == '__main__':
    baseurl = "https://game.gtimg.cn/images/lol/act/img/tft/js/15.15-2025.S15/hex.js"  # 目标网页
